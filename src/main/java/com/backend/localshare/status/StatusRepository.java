...
public interface StatusRepository extends JpaRepository<Status, Long> {
    boolean existsByObjectKey(String key);
    ...
    @Query("SELECT new com.backend.localshare.dto.StatusDTO( " +
            ...
            "(SELECT v.status.statusId FROM StatusReaction v WHERE v.userId = :userId " +
    ...
    Page<StatusDTO> getUnseenStatus(
            @Param("location") String location, @Param("userId") Long currentUserId,
